...
- **Uncertainty & Coverage**: Look for "k=2"/"coverage factor k=2" and "95% confidence" in captions/footnotes. Extract to coverageFactor and coverageProbability. Apply to ALL quantities in that table unless overridden per-row. If probability given as percentage (e.g. 95%), store as decimal (0.95).
  - **Reasoning**: You MUST provide a 'coverageReasoning' at the MeasurementResult level explaining WHICH properties the k-factor/probability were assigned to, WHY they were assigned, and WHY they were NOT assigned to other properties (e.g., "The footnote ** applies to IAEA-C7 and C8 for standard uncertainty, so no k-factor. Footnote * applies to IAEA-C4 and C9 for 95% confidence..."). This reasoning will be displayed to the user.
